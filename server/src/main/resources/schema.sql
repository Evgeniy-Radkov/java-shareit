...
CONSTRAINT fk_user_request FOREIGN KEY (requester_id) REFERENCES users(id) ON DELETE RESTRICT
);
...
CONSTRAINT fk_items_request FOREIGN KEY (request_id) REFERENCES item_request(id) ON UPDATE RESTRICT ON DELETE SET NULL
);
...
CREATE INDEX IF NOT EXISTS idx_item_request_requester ON item_request(requester_id);
CREATE INDEX IF NOT EXISTS idx_item_request_created   ON item_request(created);
